...
import Themeprimarycolor, * as switcherdata from "@/components/layout/agizzit/switcherdata";
import { Button, Nav, OverlayTrigger, Tab, Tooltip } from "react-bootstrap";

const Switcher = ({ local_varaiable, ThemeChanger }) => { 
	
	useEffect(() => {	
		//switcherdata.LocalStorageBackup(ThemeChanger); use loadThemeFromDatabase TO LOAD THEME FROM DATABASE, FUNCTION NOT COMPLETE
	}, []);
	...
	${local_varaiable.bodyBg != "" ? `--body-bg-rgb2: ${local_varaiable.bodyBg1}` : ""};
